...
{{% blocks/feature icon="fa-lightbulb" title="技术分享" %}}
分享我在编程、云原生、AI 等领域的学习笔记和实战经验。
{{% /blocks/feature %}}

{{% blocks/feature icon="fab fa-github" title="开源项目" url="https://github.com/" %}}
查看我的开源项目和贡献。
{{% /blocks/feature %}}

{{% blocks/feature icon="fa-book" title="读书笔记" url="/docs/" %}}
分享我阅读过的书籍和精华笔记。
{{% /blocks/feature %}}
