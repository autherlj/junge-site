---
title: "让科研像聊天一样简单"
linkTitle: "DeepSeek-科研应用"
weight: 13
description: "清华大学第四弹：DeepSeek 在科研领域的应用指南。"
date: 2024-02-04
params:
  author: "清华大学"
  state: "PDF 电子书"
  cover_icon: "fas fa-flask"
toc: false
...
<div class="alert alert-light border shadow-sm mb-4">
    <div class="d-flex align-items-center">
        ...
        <div class="flex-grow-1">
            <h5 class="alert-heading fw-bold mb-1">让科研像聊天一样简单</h5>
            <p class="mb-0 text-muted small">清华大学出品 · 第四弹</p>
        </div>
        <div class="flex-shrink-0 ms-3">
            <a href="/books/清华大学第四弹：让科研像聊天一样简单.pdf" class="btn btn-primary" target="_blank" download>
...
<embed src="/books/清华大学第四弹：让科研像聊天一样简单.pdf" type="application/pdf" width="100%" height="1000px" class="border rounded shadow-sm" />
